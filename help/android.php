    ...
    <div class="bg-white b-b b-light">
      <div class="container">      
        <ul class="breadcrumb no-border bg-empty m-b-none m-l-n-sm">
          ...
          <li class="active">android配置教程</li>
        </ul>
      </div>
    </div>
            ...
            <div class="post-item">
            	<div class="post-media">
                  ...
                  <div class="carousel auto slide panel-body" id="c-fade">      
                     ...
                     <span class="h1">android安卓系统配置影梭教程</span>                       
                      </div>                    
                  </div> 
                </section>
            	</div>
              <div class="caption wrapper-lg">                
                  <h2 class="post-title">一、下载android安卓影梭客户端. </h2>                
				  <div class="post-sum"><p>    
                <a href="https://github.com/shadowsocks/shadowsocks-android/releases" class="btn btn-primary m-t m-b">shadowsocks-android</a>  <a href="https://soft.alphabrock.cn/shadowsocks/ssr-3.0.4.3.apk" class="btn btn-primary m-t m-b">shadowsocksr-android</a></p>
             <div class="line line-lg"></div>
			 
			 
			 <h2 class="post-title">二、下载后安装apk，安装完成后打开App. </h2>
			   <div class="post-sum"><p>选用翻墙服务请下载:<a href="https://github.com/shadowsocks/shadowsocks-android/releases"><b>shadowsocks-android</b></a>，免流+翻墙请下载:<a href="https://soft.alphabrock.cn/shadowsocks/ssr-3.0.4.3.apk"><b>shadowsocksr-android</b></a><br>
			   	   下图中左边为只翻墙，右边为免流+翻墙<br>
                <img src="../theme/freedom/images/ss-1.png" class="img-full"><br> </p>			   
			    <div class="line line-lg"></div>
				
				
			  <h2 class="post-title">三、输入SS账号信息. </h2>
			   <div class="post-sum"><p>    
               （<a href="../user/node.php"><b>获取SS账号信息</b></a>）SS账号信息包含：“地址”、“端口”、“密码”、“加密方式”，或者直接扫描二维码<br>
               	接着打开APP，点击左上角的shadowsocks - 点击右下角+图标 - 选择手动设置，在以下界面填写信息，完成后点击左上角飞机图标连接<img src="../theme/freedom/images/ss-2.png" class="img-full"></p><br>
			
			   <div class="line line-lg"></div>
			   
			   
			   
			  <h2 class="post-title">四、使用本站提供的免流+翻墙服务 （限广东联通）</h2>			  
			   <div class="post-sum"><p>
			   （<a href="https://soft.alphabrock.cn/shadowsocks/ssr-3.0.4.3.apk"	><b>点击下载SSR-APP</b></a>）安装第三步打开填写信息页，在混淆参数填写：e.17wo.cn<br>
			  <img src="../theme/freedom/images/ss-3.png" class="img-full"></p><br>  
                </div>	
                <div class="line line-lg"></div>	
			   
			          <h2 class="post-title">五、备用Pdf教程. </h2>
        			   <div class="post-sum"><p><a href="https://soft.alphabrock.cn/shadowsocks/document/Shadowsocks%E4%BD%BF%E7%94%A8%E6%95%99%E7%A8%8B.pdf"><b>点击此处查看</b></a></p> 
                </div>	
                <div class="line line-lg"></div>
	...
	<div class="bg-dark dker wrapper">
		<div class="container text-center m-t-lg">
			...
			<div class="m-t-xl m-b-xl">
				<p> 
            <a href="android.php#content" data-jump="true" class="btn btn-icon btn-rounded btn-dark b-dark bg-empty m-sm text-muted"><i class="fa fa-angle-up"></i></a>
          	</p>
			</div>
			<div class="m-t-xl m-b-xl">
				<p> 
